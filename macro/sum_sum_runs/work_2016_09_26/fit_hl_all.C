...
void fit_hl_all(){
  ...
  TFile* ofile = new TFile("output_fit_all_runs_start_20_exclude_deadhot.root","RECREATE");
...
//  gStyle->SetOptFit(111);
  ofstream out_txt("fitting_information.txt");
  for(int i=0;i<128*24*16;i++){
    ...
    TF1* ff = new TF1(hname,fitf,20,210,2); 
