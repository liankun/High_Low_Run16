...
void fit_hl_all_switch(int group=0){
  ...
  TFile* ofile = new TFile("output_fit_switch_100_150_exclude_deadhot.root","RECREATE");
...
//  gStyle->SetOptFit(111);
  ofstream out_txt("fitting_information_100_150.txt");
  for(int i=0;i<128*24*16;i++){
    ...
    TF1* ff=new TF1(hname,fitf,100,150,2); 
