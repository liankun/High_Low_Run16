#include<fstream>
void fit_sigma(){
  TFile* ifile = new TFile("output_dist_all_runs.root","READONLY");
  if(!ifile){
    cout<<"open file failed "<<endl;
    return;
  }
  TFile* ofile = new TFile("sigma_fit_all_runs.root","RECREATE");
  ofstream out_txt("fit_sigma_result_all_runs.txt"); 
